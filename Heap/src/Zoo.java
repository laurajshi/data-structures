/**
 * Created by laurashi on 3/28/18.
 */
...
public class Zoo
{
    ...
    public void sortAnimalAge()
    {
        ...
        System.out.println("Before sort by age- " + HeapSort.toString(ages,names, comparisons, swaps));

        HeapSort.heap(ages, names, comparisons, swaps);
        System.out.println("After sort by age- " + HeapSort.toString(ages,names, comparisons, swaps));
    }
    public void sortAnimalHeight()
    {
        ...
        System.out.println("Before sort by height- " + HeapSort.toString(height,names,comparisons,swaps));

        HeapSort.heap(height,names,comparisons,swaps);

        System.out.println("After sort by height- " + HeapSort.toString(height,names,comparisons,swaps));
    }
